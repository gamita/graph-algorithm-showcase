...
export default class PrimAlgorithm {
    ...
    private step() {
        ...
        _this.mstNodeIdSet.forEach(function (nodeId: string) {
        ...
        this.graph.putEdgeProperty(<string>mstEdge.id, 'color', { color: 'orange' });
        this.graph.putEdgeProperty(<string>mstEdge.id, 'width', 7);
