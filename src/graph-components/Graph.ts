...
export default class Graph {
    ...
    private random = new Chance('NiceSeed');
    ...
    public getShuffledAllNodes(shuffleSeed: string): Array<Node> {
        ...
        let shuffler = new Chance(shuffleSeed);
    ...
    public getNode(nodeId: string | number): Node {
        ...
        return this.graphDataSet.nodes.get(nodeId) as Node;

    }


    /**
     * Return property value on a node or a edge
     * 
     * @param nodeEdge 
     * @param propsName 
     * @returns 
     */
    public getProperty(nodeEdge: Node | Edge, propsName: string): any {
        return (nodeEdge as any)[propsName];
    }


    /**
     * Return property value on a node
     * 
     * @param nodeId 
     * @param propsName 
     * @returns 
     */
    public getNodeProperty(nodeId: string | number, propsName: string): any {
        return (this.getNode(nodeId) as any)[propsName];
    }
     ...
     * @returns 
     */
    public getEdgeProperty(edgeId: string | number, propsName: string): any {
        return (this.getEdge(edgeId) as any)[propsName];
    }
    ...
    public getEdge(edgeId: string | number): Edge {
        ...
        return this.graphDataSet.edges.get(edgeId) as Edge;
    ...
    public assignEdgeLength(distancePropertyName: string): void {
        ...
        this.graphDataSet.edges.forEach((edge: Edge) => {
            ...
            let fromNode = this.graphDataSet.nodes.get(edge.from as string) as Node;
            let toNode = this.graphDataSet.nodes.get(edge.to as string) as Node;

            let distance = Math.sqrt(((fromNode.x as number - (toNode.x as number)) ** 2) + ((fromNode.y as number - (toNode.y as number)) ** 2));

            this.putEdgeProperty(edge.id as string, distancePropertyName, Math.round(distance));
    ...
    private traceToNext(nextNodeId: number | string, traceEdgePropName: string, traceNodePropName: string,
        ...
        let nextEdge: Edge = this.getEdge(this.getProperty(nextNode, traceEdgePropName));
        ...
        if (this.getProperty(nextNode, traceNodePropName)) {
            this.traceToNext(this.getProperty(nextNode, traceNodePropName), traceEdgePropName, traceNodePropName,
     ...
     * @param givenRandom 
     */
    public choseRandomNode(givenRandom = this.random): Node | null {
        return this.choseRandomFrom(this.graphDataSet.nodes.get(), givenRandom) as Node;
    }
     ...
     * @param givenRandom 
     */
    public choseRandomEdge(givenRandom = this.random): Edge | null {
        return this.choseRandomFrom(this.graphDataSet.edges.get(), givenRandom) as Edge;
    }
     ...
     * @param givenRandom 
     */
    public choseRandomNodeFrom(population: Array<Node>, givenRandom = this.random): Node | null {
        return this.choseRandomFrom(population, givenRandom) as Node;
    }
     ...
     * @param givenRandom 
     */
    public choseRandomEdgeFrom(population: Array<Edge>, givenRandom = this.random): Edge | null {
        return this.choseRandomFrom(population, givenRandom) as Edge;
    }
     ...
     * @param givenRandom 
     */
    public choseRandomFrom(population: Array<Node | Edge>, givenRandom = this.random): Node | Edge | null {
     ...
     * @param givenRandom 
     */
    public choseRandomNodeFromAndExcept(population: Array<Node>, exceptNodeIdList: Array<number | string>, givenRandom = this.random): Node | null {
        return this.choseRandomFromAndExcept(population, exceptNodeIdList, givenRandom) as Node;
    }
     ...
     * @param givenRandom 
     */
    public choseRandomEdgeFromAndExcept(population: Array<Edge>, exceptEdgeIdList: Array<number | string>, givenRandom = this.random): Edge | null {
        return this.choseRandomFromAndExcept(population, exceptEdgeIdList, givenRandom) as Edge;
    }
     ...
     * @param givenRandom 
     */
    public choseRandomFromAndExcept(population: Array<Node | Edge>, exceptIdList: Array<number | string>, givenRandom = this.random): Node | Edge | null {
     ...
     * @param givenRandom 
     */
    public choseProbabilisticallyFrom(population: Array<Node | Edge>, proportionalProp: string, givenRandom = this.random): Node | Edge | null {
        ...
        let totalProportionalValue = population.reduce((sum, element) => sum + this.getProperty(element, proportionalProp), 0.0001); // 0.0001 for avoiding zero division, afterward.
        ...
        population.forEach(element => {
            ...
            let probabilityLength = this.getProperty(element, proportionalProp) / totalProportionalValue
     ...
     * @param givenRandom 
     */
    public choseProbabilisticallyNodeFromAndExcept(population: Array<Node>, proportionalProp: string, exceptIdList: Array<number | string>, givenRandom = this.random): Node | null {

        let availablePopulation = this.excludeElementFromOriginal(population, exceptIdList);

        return this.choseProbabilisticallyFrom(availablePopulation, proportionalProp, givenRandom) as Node;
     ...
     * @param givenRandom 
     */
    public choseProbabilisticallyEdgeFromAndExcept(population: Array<Edge>, proportionalProp: string, exceptIdList: Array<number | string>, givenRandom = this.random): Edge | null {

        let availablePopulation = this.excludeElementFromOriginal(population, exceptIdList);

        return this.choseProbabilisticallyFrom(availablePopulation, proportionalProp, givenRandom) as Edge;
     ...
     * @param givenRandom 
     */
    public choseProbabilisticallyFromAndExcept(population: Array<Node | Edge>, proportionalProp: string, exceptIdList: Array<number | string>, givenRandom = this.random): Node | Edge | null {
